    ...
    <header className="bg-slate-950 py-7 text-slate-50">
      <div className={`${dashboardContentClassName} flex items-center gap-10`}>
        ...
        <div className="ml-auto flex items-center gap-3">
          <Button
            asChild
            className="h-11 gap-2 border-cyan-400/30 bg-cyan-400/10 px-4 font-[family-name:var(--font-rajdhani)] text-base font-bold uppercase tracking-wide text-cyan-100 hover:bg-cyan-400/20"
          >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                size="icon-lg"
                variant="outline"
                className="border-slate-700 bg-slate-900 text-slate-200 hover:bg-slate-800 hover:text-cyan-100"
